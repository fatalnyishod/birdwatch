			...
			<div className="grid subscription__grid">
				...
				<div className="subscription__socials">
					<a href="#" target="_blank" className="subscription__socials-item">
						<img src={require('../../../../assets/images/icons/main/twitter.svg')} className="subscription__socials-item"/>
					</a>

					<a href="#" target="_blank" className="subscription__socials-item">
						<img src={require('../../../../assets/images/icons/main/ok.svg')} className="subscription__socials-item"/>
					</a>

					<a href="#" target="_blank" className="subscription__socials-item">
						<img src={require('../../../../assets/images/icons/main/vk.svg')} className="subscription__socials-item"/>
					</a>
				</div>
			</div>
